...
BEGIN
  ...
  SELECT id INTO v_experiencias FROM categories WHERE slug = 'experiencias';
  SELECT id INTO v_cestas FROM categories WHERE slug = 'cestas-de-presentes';
  SELECT id INTO v_livros FROM categories WHERE slug = 'livros-e-papelaria';
  SELECT id INTO v_eletronicos FROM categories WHERE slug = 'eletronicos';
  SELECT id INTO v_casa FROM categories WHERE slug = 'casa-e-cozinha';

  INSERT INTO products (id, name, slug, description, short_description, price, compare_at_price, sku, stock, is_active, images, category_id, created_at, updated_at)
  VALUES
    (gen_random_uuid(), 'Caixa de Bombons Belga', 'caixa-bombons-belga', 'Caixa com 12 chocolates belgas de diferentes sabores. Perfeito para presentear em qualquer ocasião. Cada chocolate é feito à mão com ingredientes premium importados da Bélgica.', '12 chocolates belgas artesanais', 89.90, 109.90, 'CHOC-001', 50, true, '["/images/products/chocolates.jpg","/images/products/chocolates-side.jpg","/images/products/chocolates-open.jpg"]', v_chocolates, NOW(), NOW()),
    (gen_random_uuid(), 'Trufas Artesanais Sortidas', 'trufas-artesanais-sortidas', 'Caixa com 24 trufas artesanais nos sabores: chocolate ao leite, dark, branco, avelã e maracujá. Produzidas diariamente com ingredientes frescos.', '24 trufas de sabores variados', 69.90, NULL, 'CHOC-002', 75, true, '["/images/products/chocolates.jpg"]', v_chocolates, NOW(), NOW()),
    (gen_random_uuid(), 'Buquê de Rosas Vermelhas', 'bouquet-rosas-vermelhas', 'Buquê com 24 rosas vermelhas frescas, envolto em papel kraft e fita de cetim. Perfeito para declarações de amor e aniversários.', '24 rosas vermelhas frescas', 189.90, 229.90, 'FLO-001', 20, true, '["/images/products/flores.jpg","/images/products/flores-detail.jpg"]', v_flores, NOW(), NOW()),
    (gen_random_uuid(), 'Arranjo de Orquídeas', 'arranjo-orquideas', 'Vaso com orquídea Phalaenopsis branca. Planta elegante e duradoura que floresce por meses. Ideal para decoração sofisticada.', 'Orquídea Phalaenopsis em vaso', 159.90, NULL, 'FLO-002', 15, true, '["/images/products/flores.jpg"]', v_flores, NOW(), NOW()),
    (gen_random_uuid(), 'Vinho Tinto Premium', 'vinho-tinto-premium', 'Garrafa de vinho tinto chileno Cabernet Sauvignon reserva. Safra 2020, envelhecido por 12 meses em barris de carvalho francês. Notas de frutas vermelhas e especiarias.', 'Cabernet Sauvignon Reserva 2020', 289.90, 349.90, 'VIN-001', 15, true, '["/images/products/vinho.jpg","/images/products/vinho-label.jpg","/images/products/vinho-glass.jpg"]', v_bebidas, NOW(), NOW()),
    (gen_random_uuid(), 'Champagne Moët & Chandon', 'champagne-moet-chandon', 'Garrafa de Champagne Moët & Chandon Impérial 750ml. Elegante e sofisticado, perfeito para celebrações especiais.', 'Moët & Chandon Impérial 750ml', 349.90, NULL, 'VIN-002', 10, true, '["/images/products/vinho.jpg"]', v_bebidas, NOW(), NOW()),
    (gen_random_uuid(), 'Kit Spa Relaxante', 'kit-spa-relaxante', 'Kit completo com óleos essenciais de lavanda, velas aromáticas, sais de banho e máscara facial. Perfeito para criar um ambiente de spa em casa.', 'Kit completo de spa em casa', 199.90, 249.90, 'SPA-001', 30, true, '["/images/products/spa.jpg"]', v_bemestar, NOW(), NOW()),
    (gen_random_uuid(), 'Difusor de Aromas Premium', 'difusor-aromas-premium', 'Difusor de aromas em cerâmica artesanal com 3 óleos essenciais: eucalipto, lavanda e capim-limão. Duração de até 90 dias.', 'Cerâmica artesanal + 3 óleos', 129.90, NULL, 'SPA-002', 25, true, '["/images/products/spa.jpg"]', v_bemestar, NOW(), NOW()),
    (gen_random_uuid(), 'Relógio Elegante', 'relogio-elegante', 'Relógio com design elegante e pulseira de couro legítimo. Resistência à água IP67. Movimento japonês de alta precisão. Caixa em aço inoxidável.', 'Design clássico com pulseira de couro', 459.90, 599.90, 'REL-001', 10, true, '["/images/products/joias.jpg","/images/products/joias-side.jpg","/images/products/joias-detail.jpg"]', v_acessorios, NOW(), NOW()),
    (gen_random_uuid(), 'Colar de Prata com Pingente', 'colar-prata-pingente', 'Colar em prata 925 com pingente de coração banhado a ouro rosé. Acompanha caixa de presente e certificado de autenticidade.', 'Prata 925 com banho ouro rosé', 259.90, NULL, 'ACE-001', 20, true, '["/images/products/joias.jpg"]', v_acessorios, NOW(), NOW()),
    (gen_random_uuid(), 'Caneca Personalizada Térmica', 'caneca-personalizada-termica', 'Caneca térmica em aço inox 500ml com personalização laser. Mantém bebidas quentes por 12h e frias por 24h. Ideal para presentes corporativos.', 'Aço inox 500ml com gravação laser', 79.90, NULL, 'CAN-001', 100, true, '["/images/products/perfume.jpg"]', v_personalizados, NOW(), NOW()),
    (gen_random_uuid(), 'Álbum de Fotos Personalizado', 'album-fotos-personalizado', 'Álbum de fotos capa dura com 40 páginas. Personalização na capa com nome e data. Papel fotográfico de alta qualidade.', '40 páginas com capa personalizada', 149.90, 189.90, 'PER-001', 35, true, '["/images/products/perfume.jpg"]', v_personalizados, NOW(), NOW()),
    (gen_random_uuid(), 'Almofada Decorativa Veludo', 'almofada-decorativa-veludo', 'Almofada decorativa em veludo premium 45x45cm. Tecido 100% poliéster com enchimento em fibra siliconada. Disponível em 8 cores.', 'Veludo premium 45x45cm', 89.90, NULL, 'ALM-001', 45, true, '["/images/products/chocolates.jpg"]', v_decoracao, NOW(), NOW()),
    (gen_random_uuid(), 'Porta-joias Artesanal', 'porta-joias-artesanal', 'Porta-joias de madeira MDF com acabamento em veludo interno. 3 compartimentos organizados com espelho na tampa.', 'Madeira com veludo interno', 129.90, NULL, 'JOI-001', 25, true, '["/images/products/joias.jpg"]', v_decoracao, NOW(), NOW()),
    (gen_random_uuid(), 'Vale Experiência Gourmet', 'vale-experiencia-gourmet', 'Voucher para jantar em restaurante estrelado Michelin. Válido para 2 pessoas com menu degustação de 5 tempos. Validade de 12 meses.', 'Jantar degustação para 2 pessoas', 499.90, NULL, 'EXP-001', 50, true, '["/images/products/experiencia.jpg"]', v_experiencias, NOW(), NOW()),
    (gen_random_uuid(), 'Cesta de Café da Manhã', 'cesta-cafe-manha', 'Cesta de vime com pães artesanais, queijos importados, frutas frescas, suco natural, mel orgânico e geleia artesanal. Perfeita para surpreender.', 'Cesta gourmet completa', 249.90, 299.90, 'CES-001', 18, true, '["/images/products/cesta.jpg"]', v_cestas, NOW(), NOW()),
    (gen_random_uuid(), 'Cesta de Chocolates Premium', 'cesta-chocolates-premium', 'Cesta decorada com chocolates importados: Lindt, Ferrero Rocher, Godiva e trufas artesanais. Aproximadamente 1kg de chocolates.', '1kg de chocolates importados', 329.90, 399.90, 'CES-002', 12, true, '["/images/products/cesta.jpg"]', v_cestas, NOW(), NOW()),
    (gen_random_uuid(), 'Jogo de Panelas Premium', 'jogo-panelas-premium', 'Jogo com 7 peças em aço inox 18/10. Antiaderente e compatível com indução. Inclui: 2 panelas, 1 frigideira, 1 leiteira e 1 panela de pressão.', '7 peças aço inox 18/10', 599.90, 799.90, 'PAN-001', 8, true, '["/images/products/panelas.jpg"]', v_casa, NOW(), NOW()),
    (gen_random_uuid(), 'Fone Bluetooth Premium', 'fone-bluetooth-premium', 'Fone de ouvido sem fio com cancelamento de ruído ativo. Bateria de 30 horas. Driver de 40mm com som Hi-Fi. Dobrável com estojo de transporte.', 'Cancelamento de ruído ativo, 30h bateria', 349.90, 449.90, 'FON-001', 22, true, '["/images/products/fone.jpg"]', v_eletronicos, NOW(), NOW()),
    (gen_random_uuid(), 'Smartwatch Fitness', 'smartwatch-fitness', 'Smartwatch com monitor cardíaco, GPS integrado, resistente à água IP68. Tela AMOLED 1.4". Bateria de 14 dias. Compatível com iOS e Android.', 'Monitor cardíaco + GPS integrado', 599.90, NULL, 'SMA-001', 15, true, '["/images/products/fone.jpg"]', v_eletronicos, NOW(), NOW());
