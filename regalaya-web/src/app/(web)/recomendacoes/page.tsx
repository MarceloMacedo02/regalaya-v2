...
import { toast } from 'react-hot-toast'; // Assume toast is available or use alert
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        ...
                        <div className="mt-auto flex flex-col space-y-2">
                          <div className="grid grid-cols-5 gap-2 items-center">
                            <Link href={`/produtos/${sugestao.slug || sugestao.id}`} className="col-span-3">
                              <button className="w-full bg-gray-900 text-white font-bold py-2.5 px-4 rounded-xl hover:bg-gray-800 transition-colors flex items-center justify-center">
